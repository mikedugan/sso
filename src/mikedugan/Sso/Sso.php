...
use Sso\OAuthConsumer;
use Sso\OAuthRequest;
use Sso\OAuthSignatureMethod;
use Sso\OAuthSignatureMethod_RSA_SHA1;
use Sso\SSO_OAuthSignatureMethod_RSA_SHA1;
use Sso\OAuthToken;
use Sso\OAuthUtil;
...
class Sso
{
    ...
    public function __construct($base, $key, $secret, $method, $cert)
    {
